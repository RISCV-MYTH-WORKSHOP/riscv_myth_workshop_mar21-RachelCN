   ...
   |cpu
      ...
      @1   
         ...
         $imm[31:0] = $is_i_instr ? {{21{$instr[31] }}, $instr[30:20]}:
                      ...
                      $is_j_instr ? {{12{$instr[31]}}, $instr[19:12], {2{$instr[20]}}, $instr[30:21] , 1'0} : 0 ;
      ...
      @2  
         ...
         `BOGUS_USE($is_beq $is_bne $is_blt $is_bge $is_bltu $is_bgeu $is_addi $is_add $is_load $is_lui $is_auipc $is_jal $is_jalb $is_sra
                     $is_and $is_or $is_sb $is_sh $is_sw $is_slti $is_sltiu $is_xori $is_ori $is_andi $is_slli $is_srli $is_sral $is_sub $is_sll $is_slt $is_sltu $is_xor $is_srl)
      @2   
         //register file read
      ...
      @5
         ...
         *passed = |cpu/xreg[17]>>1$value == (1+2+3+4+5+6+7+8+9) ;
